# video on the basic working : https://youtu.be/48o-mjgdMsE
# video on qr code app : https://youtu.be/YSNuGEzo2HA
...
# now you can convert this .py file to .exe file that will run on all computer without python or any other software development kit
# to convert . py to .exe check this video  : https://youtu.be/dKJyRzNSs6g